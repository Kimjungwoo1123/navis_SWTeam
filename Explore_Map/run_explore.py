...
- explore_and_map.py, Drive/Steer/steer_control.py, Drive/Throttle/throttle_control.py 만 실행
...
def main():
    parser = argparse.ArgumentParser(description="Explore_Map+Steer+Throttle을 한번에 실행하고 감시")
    ...
    print("[run_explore] 3개 프로세스 실행 중 - Camera/Path_Planning은 이 단계에선 켜지 않음 (Ctrl+C 로 전체 종료)")
    try:
        while True:
